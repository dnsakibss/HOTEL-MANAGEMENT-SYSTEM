...
{	
	...
	public RoomManagerFrame(EmployeeList emplist,CustomerList cuslist,RoomList roomlist){
		super("Room Manager");
	...
	public void initializeFrame(){
		...
		//Crating a Labels
		label = new JLabel("Room Information");
		...
		JLabel roomPriceLable = new JLabel("Price per Day");
