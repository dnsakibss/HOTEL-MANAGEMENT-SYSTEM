...
{	
	...
	public CustomerManagerFrame(EmployeeList emplist,CustomerList cuslist,RoomList roomlist){
		super("Guest Manager");
	...
	public void initializeFrame(){
		...
		//BackGround Example
		ImageIcon image = new ImageIcon("Resources/guest.jpg");
