...
{	
	...
	public EmployeeManagerFrame(EmployeeList emplist,CustomerList cuslist,RoomList roomlist){
	...
	public void initializeFrame(){
		...
		//Crating a Labels
		label = new JLabel("Employee Information");
		...
		back.setFont(font);
		back.setBounds(910,50,150,40);
		back.addActionListener(this);
		
		update = new JButton("Update");
		update.setFont(font);
		update.setBounds(610,50,150,40);
